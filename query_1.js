 ...
 * Difficulty: Beginner
 * Concept: SELECT + WHERE (Filtering with conditions)
 *
 * Question:
 * Write an SQL query to get names and salaries of all employees
 * in the IT department earning more than 50,000.
 */
